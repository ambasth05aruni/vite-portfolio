...
import CV from '../../assets/Arunima-Cv.pdf'
  ...
  return (
    <main className="section container">
      ...
      <section className="skills">
        <h3 className="section__subtitle subtitle__center section__title">My Skills</h3>
      ...
      <section className="resume">
        <h3 className="section__subtitle subtitle__center section__title">
